                    ...
                    <div id="tabs-content ">
                      <div id="tab1" className="tab-content">
                        ...
                        <div>
                          ...
                          <p className="mt-4">
                            {course.description}Join us for a rejuvenating
                            experience that will leave you feeling grounded,
                            energized, and centered.
                            <br /> <br /> Discover balance, strength, and inner
                            peace through our all-levels yoga course. Whether
                            you're a beginner looking to learn the fundamentals
                            or an experienced practitioner seeking to deepen
                            your practice, this course offers a holistic
                            approach to yoga that nurtures both body and mind.
                            Each session combines mindful movement, breathwork,
                            and relaxation techniques to help you cultivate
                            flexibility, improve posture, and reduce stress.
                          </p>
                          <div className="bg-[#F8F8F8] dark:bg-indigo-500 space-y-6 p-8 rounded-md my-8">
                      ...
                      <div id="tab2" className="tab-content">
                        <div>
                          ...
                          <p className="mt-4">
                            In this 60-minute yoga class, students will be
                            guided through a balanced practice that fosters
                            physical strength, flexibility, and mental clarity.
                            The session begins with a brief welcome and
                            centering, allowing participants to settle into the
                            space with a few minutes of deep breathing or
                            meditation. A 10-minute warm-up follows, including
                            gentle movements, Cat-Cow poses, and several rounds
                            of Sun Salutations to build heat and prepare the
                            body for deeper postures.
                            <br /> <br /> The main sequence, lasting 25 minutes,
                            includes standing poses like Warrior I & II,
                            Triangle Pose, and Tree Pose for balance, as well as
                            core-strengthening postures such as Plank and Boat
                            Pose. Students will then move into hip openers and
                            forward bends with Pigeon Pose and Seated Forward
                            Bend to release tension and increase flexibility.
                          </p>
                        </div>
                      </div>
                    </div>
